# 📦 HelloFresh Revenue and Cost Optimization Analysis

Analysis of HelloFresh revenue and cost patterns to support profit optimization and better operational decision making using **SQL, Excel, and Power BI**.
...
* Data collected from HelloFresh public financial reports
* PDF reports converted into structured Excel datasets
* Raw data required formatting and standardization
* Inconsistent and misspelled values were corrected
* Missing and duplicate records were handled
* Column names and formats were normalized
* Clean dataset loaded into SQL and Power BI for analysis
...
* Revenue contribution is uneven across regions
* Growth rates vary significantly by region and year
* Profitability margins differ strongly across regions
* The meal kit segment contributes a major share of revenue and profit
* Average order value explains revenue growth vs order volume changes
* Procurement, cooking, and marketing form a large portion of costs
* Inventory and ingredient values show capital locked in stock
